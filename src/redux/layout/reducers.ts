...
const INIT_STATE = () => {
  ...
  return {
    ...
    sideBarTheme: (params['menu_theme'] === 'dark') ? SideBarTheme.LEFT_SIDEBAR_THEME_DARK : (params['menu_theme'] === 'brand') ? SideBarTheme.LEFT_SIDEBAR_THEME_BRAND : (params['menu_theme'] === 'gradient') ? SideBarTheme.LEFT_SIDEBAR_THEME_GRADIENT : SideBarTheme.LEFT_SIDEBAR_THEME_LIGHT,
